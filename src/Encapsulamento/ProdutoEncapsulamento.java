...
public class ProdutoEncapsulamento {
    private final String nomeProduto;   // PRIVATE=>o elemento so pode ser acessada pela classe em esta foi declarada
    final double precoProduto; // sem private, ela cumpre a mesma regra, pode ser acessada por uma classe do mesmo pacote
    private int quantidadeProduto;
    //PUBLIC => pode ser acessada por todas as classes
